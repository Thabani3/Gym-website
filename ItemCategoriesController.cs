...
namespace HealthAW.Controllers
{
    public class ItemCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemCategoryId,ItemCategoryName")] ItemCategory itemCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemCategoryId,ItemCategoryName")] ItemCategory itemCategory)
        {
            if (ModelState.IsValid)
            {
